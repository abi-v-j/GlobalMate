...
const JobType = () => {
  const TABLE = "tbl_jobType";
  const COL = "jobType_name";
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          ...
          <div>
            ...
            >
              Create, edit and manage job types
            </Typography>
          </div>
        </div>
      ...
      <div style={{ display: "flex", gap: 24, alignItems: "flex-start", flexWrap: "wrap" }}>
        ...
        >
          ...
          <div style={{ position: "relative", zIndex: 1, padding: "26px 22px" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 22 }}>
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  >
                    {editId ? "Edit Job Type" : "New Job Type"}
                  </Typography>
                  <Typography
                    sx={{
                  ...
                  >
                    {editId ? "Modify existing entry" : "Add a new job type"}
                  </Typography>
                </motion.div>
              </AnimatePresence>
            </div>
            ...
            <TextField
              ...
              variant="outlined"
              placeholder={editId ? "Edit job type…" : "e.g. Full-time, Contract…"}
        ...
        >
          ...
          <div style={{ position: "relative", zIndex: 1, padding: "26px 22px" }}>
            ...
            >
              {["#", "Job Type Name", "Actions"].map((h, idx) => (
                <Typography
                  key={h}
                  sx={{
                    color: "rgba(255,255,255,0.32)",
            ...
            >
              {loading ? (
                ...
                >
                  ...
                  >
                    {search ? "No results found" : "No job types yet — add one!"}
                  </Typography>
                </motion.div>
              ) : (
